...
## Corpus Check
- 81 files · ~141,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 728 nodes · 1057 edges · 102 communities (55 shown, 47 thin omitted)
...
- Project graphify Trigger
- Sub-Agent Roster
- Handover Testing Checklist
- graphify Export References
...
Cohesion: 0.06
Nodes (44): BaseModel, Bikes, Collections, ComponentHistory, Components, ComponentTypes, Incidents, Meta (+36 more)
...
### Community 10 - "Entity Creation & Update Logic"
Cohesion: 0.17
Nodes (7): generate_unique_id(), Method to create collection, Method to add incident record, Method to update incident record (supports full or partial updates), Method to add workplan and optionally link to source incident, Method to update workplan (supports full or partial updates), Function to generates a random and unique ID
...
Cohesion: 0.08
Nodes (35): add_collection(), add_incident_record(), add_service(), add_workplan(), bulk_add_service_records(), component_modify(), component_types_modify(), create_component() (+27 more)
...
Cohesion: 0.06
Nodes (40): calculate_percentage_reached(), format_component_status(), format_cost(), generate_incident_title(), generate_workplan_title(), get_formatted_bikes_list(), get_incident_data_tuple(), get_workplan_data_tuple() (+32 more)
...
### Community 34 - "Details Page Endpoints"
Cohesion: 0.33
...
### Community 29 - "graphify Skill Overview"
Cohesion: 0.08
...
### Community 94 - "graphify Export References"
Cohesion: 0.22
...
### Community 96 - "graphify Add & Watch Reference"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 97 - "graphify Hooks Reference"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 98 - "graphify Update Reference"
Cohesion: 0.50
...
## Knowledge Gaps
- **110 isolated node(s):** `Docs Maintainer Agent`, `Product Manager Agent`, `Version Script CI Workflow`, `Handovers Directory Guide`, `Handover Template` (+105 more)
...
- **Why does `BusinessLogic` connect `Business Logic Core` to `Bike & Component Queries`, `Entity Creation & Update Logic`, `Component Status Updates`, `Creation & Validation Logic`, `Record Update & Refresh Logic`, `Component Type Validation Logic`, `Database Models & Backend Utils`, `Service Record Validation`, `Database Models: Core Tables`, `Collection Status Logic`, `APScheduler Jobs`?**
...
- **What connects `Docs Maintainer Agent`, `Product Manager Agent`, `Version Script CI Workflow` to the rest of the system?**
