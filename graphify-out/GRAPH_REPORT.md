...
## Corpus Check
- 80 files · ~139,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 644 nodes · 996 edges · 85 communities (41 shown, 44 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.78)
- Token cost: 457,430 input · 0 output
...
- `graphify Skill Trigger` --conceptually_related_to--> `graphify Integration Rules`  [INFERRED]
...
Cohesion: 0.09
Nodes (39): Current Version File (v0.4.9.1f9734e), CSS Inline-Style-to-Class Refactoring, Workplan Hub Integration Plan, Opt-in Workplan Hub Pattern, Base Template, btn_new_incident Macro (Bike Details), btn_new_workplan Macro (Bike Details), Bike Details Template (+31 more)
...
Cohesion: 0.11
Nodes (19): Method to produce payload for page component overview, Method to produce payload for page component details, Calculate lifetime and service triggers for a component, Method to produce payload for page bike overview, Method to create component-to-collection mapping dictionaries, Method to produce payload for page incident reports, Method to build dictionaries of bike and component ids referenced in received…, Method to produce payload for page of all workplans (+11 more)
...
Cohesion: 0.22
Nodes (20): Architect Agent, Code Reviewer Agent, Database Expert Agent, Docs Maintainer Agent, Fullstack Developer Agent, Product Manager Agent, UX Designer Agent, Version Script CI Workflow (+12 more)

### Community 8 - "Workplan Business Logic"
Cohesion: 0.13
Nodes (17): Method to produce payload for workplan details page, Method to check if all affected components have linked services, Method to get incidents that can be linked to a workplan, generate_incident_title(), generate_workplan_title(), get_incident_data_tuple(), get_workplan_names_dict(), parse_checkbox_progress() (+9 more)
...
Cohesion: 0.12
Nodes (18): graphify Skill Trigger, graphify add & --watch Reference, graphify Additional Exports & Benchmark, Confidence Score Rubric, Extraction Subagent Prompt Spec, Hyperedges Rule, Node ID Format Rule, Semantic Similarity Edge Rule (+10 more)

### Community 11 - "Backend Module Entry Points"
Cohesion: 0.16
Nodes (12): Incidents, Model for table: incidents, calculate_percentage_reached(), get_current_version(), parse_button_sorting(), Function to get current program version, Function to calculate remaining service interval or remaining lifetime as…, Function to read configuration file (+4 more)
...
Cohesion: 0.15
Nodes (9): Method to create component, Method to create installation history record, Method to orchestrate swap of one component with another, Method to validate quick swap operation, Method to create collection, Method to check if a bike has all mandatory components and respects max…, Method to add incident record, generate_unique_id() (+1 more)
...
Cohesion: 0.13
Nodes (15): Bikes, Meta, Extends model with extra attributes, Extends model with extra attributes, Model for table: services, Extends model with extra attributes, Extends model with extra attributes, Extends model with extra attributes (+7 more)
...
Cohesion: 0.15
Nodes (13): BaseModel, Collections, ComponentHistory, ComponentTypes, Model for table: collections, Model for table: component_history, Base model for inheritance, Model for table: workplans (+5 more)
...
## Knowledge Gaps
- **41 isolated node(s):** `backup_db.sh script`, `create-container-vs2000.sh script`, `Communication & Output Rules`, `Code Style & Standards`, `Debugging & Bug Fixing Rules` (+36 more)
...
- **What connects `backup_db.sh script`, `create-container-vs2000.sh script`, `Communication & Output Rules` to the rest of the system?**
  _41 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `DB Migration Script` be split into smaller, more focused modules?**
